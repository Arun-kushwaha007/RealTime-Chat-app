...
const api = 'https://api.multiavatar.com/45645';
...
export default function SetAvatar() {
      ...
      for (let i = 0; i < 4; i++) {
        try {
          ...
          if (error.response && error.response.status === 429) {
            toast.error('Too many requests. Please wait a monent or try again later.', toastOptions);
            break;
          } else {
  ...
  return (
    ...
    {
        isLoading ? <Container>
                <img src={loader} alt="loader"className='loaser' />
        </Container>: (
